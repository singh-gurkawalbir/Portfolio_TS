  ...
  return (
    ...
    >
      <ul
        ...
        className={cn(
          // change gap-16
          " flex min-w-full shrink-0 gap-16 py-1 w-max flex-nowrap",
          ...
          >
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                ...
                <div className="me-3">
                  <img className="h-14 w-14 rounded-full" src={item.profile} alt="profile" />
                </div>
                <span className="flex flex-col gap-1">
                  {/* change text color, font-normal to font-bold, text-xl */}
                  <a href={item.link} target="_blank"><span className="text-xl font-bold leading-[1.6] text-white">
                    {item.name}
                  </span>
                  </a>
                  {/* change text color */}
